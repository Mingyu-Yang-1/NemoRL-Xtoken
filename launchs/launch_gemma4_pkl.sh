#!/bin/bash
# Launch Llama-3.1-8B ← Gemma-4-26B-A4B (P-KL) distillation chain + auto-eval watcher.
#
# See launchs/launch_phi4_hkl.sh for full docs — same pattern.
...
CONFIG=examples/configs/single_teacher_cross_tokenizer_llama8b_gemma4_26b_arrow_pkl.yaml
MAX_STEPS=10000
N_JOBS=5
NODES=32
ACCOUNT=nvr_lpr_llm
...
echo "==================================================="
echo " Launching Llama-8B ← Gemma-4-26B-A4B (P-KL) distillation"
echo "==================================================="
echo "  config       : $CONFIG"
